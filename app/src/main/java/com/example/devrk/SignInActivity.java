...
import com.example.devrk.databinding.ActivitySignInBinding;
import com.example.devrk.databinding.ActivitySignUpBinding;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            users.setProfilepic(users.setProfilepic());
